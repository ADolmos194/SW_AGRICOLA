...
let columns = ref([
    ...
    { key: "line", name: "Linea", order: true, search: true, class: 'text-center' },
    { key: "nameline", name: "Denom. Linea", order: true, search: true, class: 'text-center', chip: true },
    { key: "center", name: "Centro", order: true, search: true, class: 'text-center', chip: true },
    { key: "warehouse", name: "Almacen", order: true, search: true, class: 'text-center', chip: true },
...
const listData = async () => {
    ...
    const config = {
        method: "get",
        url: `/ratios-production-detail/${ratio.id}/1-2`,
    };
...
const onNew = () => {
    router.push({ name: 'proyswarm-prospeccioncentropoblados-prospeccion_centro_poblado_create' })
}

const onEdit = (item) => {
    router.push({ name: 'proyswarm-prospeccioncentropoblados-prospeccion_centro_poblado_update', params: { id: item.id } })
}
                ...
                <VCard>
                    ...
                    <VCardText class="d-flex flex-wrap py-4 gap-4">
                        ...
                        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
                            ...
                            :to="{ name: 'packingscreen-ratios-ratiosProduction-ratioProductionAddUpdate' }">
                                Nuevo
                            </VBtn>
