...
const props = defineProps(['onEdit', 'onDelete', 'data', 'colums', 'onCol', 'isLoading', 'searchQuery', 'rowPerPage', 'filters', 'onSelected',  'onInput', 'onInputSecondary', 'id'])
        ...
        <tbody v-if="!props.isLoading">
            ...
            <tr v-for="   item    in    dataTemp   " :key="item.id">
                ...
                <td v-if="stateDelete || stateEdit || stateInput || stateInputSecondary" class="text-center" style="width: 5rem;">
                    ...
                    <VBtn v-if="stateInputSecondary" icon size="x-small" color="success" variant="text"
