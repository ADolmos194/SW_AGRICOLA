...
const onSubmit = async () => {
    ...
    const config = {
        ...
        url:  accion.value == 1? "/travel-country/create": "/travel-country/update/" + id.value.toString(),
        data: data,
    };
...
const onDelete = async (item: any) => {
    ...
    const config = {
        method: "delete",
        url: "/travel-country/delete/" + id.value.toString(),
        data: data,
    };
    ...
    <section>
        ...
        <VNavigationDrawer temporary :width="400" location="end" class="scrollable-content"
            ...
            <div class="d-flex align-center pa-6 pb-1">
                <h6 class="text-h6">
                    {{ accion == 1 ? 'NEW COUNTRY' : 'EDIT COUNTRY'  }}
                </h6>
                    ...
                    <VCardText>
                        ...
                        <VForm ref="refForm"  @submit.prevent="onSubmit">
                            <VRow>
                                ...
                                <VCol cols="12">
                                    <VCheckbox v-model="travelLog.risk" label="Country Risk"/>
                                </VCol>
