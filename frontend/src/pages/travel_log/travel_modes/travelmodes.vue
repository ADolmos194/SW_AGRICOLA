...
const onSubmit = async () => {
    ...
    const config = {
        ...
        url:  accion.value == 1? "/travel-mode/create": "/travel-mode/update/" + id.value.toString(),
        data: data,
    };
...
const onDelete = async (item: any) => {
    ...
    const config = {
        method: "delete",
        url: "/travel-mode/delete/" + id.value.toString(),
        data: data,
    };
    ...
    <section>
        ...
        <VNavigationDrawer temporary :width="400" location="end" class="scrollable-content"
            ...
            <div class="d-flex align-center pa-6 pb-1">
                <h6 class="text-h6">
                    {{ accion == 1 ? 'NEW TRAVEL MODES' : 'EDIT TRAVEL MODES'  }}
                </h6>
