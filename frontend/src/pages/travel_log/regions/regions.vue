...
const onSubmit = async () => {
    ...
    const config = {
        ...
        url:  accion.value == 1? "/travel-region/create": "/travel-region/update/" + id.value.toString(),
        data: data,
    };
...
const onDelete = async (item: any) => {
    ...
    const config = {
        method: "delete",
        url: "/travel-region/delete/" + id.value.toString(),
        data: data,
    };
    ...
    <section>
        ...
        <VNavigationDrawer temporary :width="400" location="end" class="scrollable-content"
            ...
            <div class="d-flex align-center pa-6 pb-1">
                <h6 class="text-h6">
                    {{ accion == 1 ? 'NEW REGIONS' : 'EDIT REGIONS'  }}
                </h6>
